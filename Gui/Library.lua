...
local function PlayProIntro(callback)
    task.spawn(function()
        ...
        Kanji.BackgroundTransparency = 1; Kanji.Text = "TURKHUB"; Kanji.Font = Enum.Font.GothamBlack; Kanji.TextSize = 0; Kanji.TextColor3 = Color3.fromRGB(150, 50, 255); Kanji.TextTransparency = 1
        ...
        NameTitle.BackgroundTransparency = 1; NameTitle.Text = "T-TURKHUB"; NameTitle.Font = Enum.Font.GothamBold; NameTitle.TextSize = 0; NameTitle.TextColor3 = Color3.fromRGB(255,255,255); NameTitle.TextTransparency = 1
...
function Library:CreateWindow(windowName)
    ...
    TitleText.BackgroundTransparency = 1; TitleText.Text = windowName or "TURKHUB"  
